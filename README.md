...
I bridge the gap between complex data structures and economic insights. My focus lies in using statistical modeling and machine learning to decode market trends and drive data-informed decision-making.
...
### 🔬 Key Projects
I specialize in collaborative data projects, in order to build end-to-end analytical pipelines.

- **LinkedIn Smart Recommender** 🤖
  *Developed an intelligent recommendation system tailored for LinkedIn, leveraging Machine Learning algorithms to optimize professional networking and content matching.*
